...
"""
print "develop debug only network.py"
...
def get_ip_address(ifname):
    ...
    """
    try:
        # this won't work on windows, but the except case will handle it.
        # perhaps we could add some code to detect this, and not bother with this,
        # but it can't be called all that often :)
...
def get_active_ifaces():
    ...
    @rtype: list
    """
    # TODO: Figure out how to do better OS independence
    return ['eth0']
    try:

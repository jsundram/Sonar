...
#                print "data before: " + data
                data = before.group() + objectid.group() + browseflag.group() + filter.group() + startingindex.group() + requestedcount.group() + sortcriteria.group() + after.group()
#                print "data after: " + data
...
#            data = r.getfile().read(message_len)
        ...
        #return response payload
        # NAS is sending some non utf-8 data
        try:

...
#__path__.append('/usr/lib/python2.6/site-packages/brisa/upnp/control_point')
...
######################################################################
#from brisa.upnp.control_point.service import Service, SubscribeRequest, UnsubscribeRequest, StateVariable, ServiceBuilder, RenewSubscribeRequest, AutoRenew
import brisa.upnp.control_point.service
import brisa.upnp.control_point.control_point
import brisa.upnp.control_point.control_point_av
import brisa.upnp.control_point.event
import brisa.upnp.control_point.device_builder
######################################################################
